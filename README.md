...
| **Computer Vision** | OpenCV • CNNs • Object detection/segmentation • Edge detection/segmentation • Edge deployment basics | Quality inspection + safety detection (defects, PPE, hazards) |
